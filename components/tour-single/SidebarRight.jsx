...
const SidebarRight = ({hajj}) => {
  const params = useParams()
  const {data, isSuccess} = useGetContentsByMenuContentIdQuery(params.slug);
  useEffect(() => {
    const script = document.createElement("script");
    script.src = hajj ? "https://widgets.bokun.io/assets/javascripts/apps/build/BokunWidgetsLoader.js?bookingChannelUUID=d894d0d4-5eab-4e15-821d-6770f0186810" :
  ...
  return (
    <div className="d-flex justify-end js-pin-content">
      ...
      {
        hajj ? (<div class="bokunWidget" data-src="https://widgets.bokun.io/online-sales/d894d0d4-5eab-4e15-821d-6770f0186810/experience-calendar/828452"></div>) : ""
      }
